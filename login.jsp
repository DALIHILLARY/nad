...
input::placeholder{
    ...
    <![endif]-->
        ...
        <!-- Session mgt -->
<%
	 session.removeAttribute("granted");

	String conf = (String) session.getAttribute("failed");
	String done = (String) session.getAttribute("done");
	
	if(conf != null){
	  out.println("<script>alert('Either your email or your password is wrong')</script>");
	  session.removeAttribute("failed1");
	}
	
	if(done != null){
	  out.println("<script>alert('Registration successful, please enter your credentials to login')</script>");
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-8 m-auto">
                    ...
                    <h3 style="color:white;">Bus Reservation</h3>

							<form method="POST" action="http://localhost:8080/Bus-Reservation/login">
								<div class="username">
									<input type="email" placeholder="Enter Email" name="email" required style="color:white; border: 1px solid white;">
								</div>
                                <div class="username">
									<input type="password" placeholder="Enter Password" name="pass"  required style="color:white; border: 1px solid white;">
								</div>
									<input type="hidden" name="hidden" value="hiden">
									
								<div class="log-btn">
									<button type="submit" name="bookTicket"><i class="fa fa-sign-in"></i>LOGIN</button>
								</div><br>
